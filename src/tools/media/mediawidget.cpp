...
//media tool slightly based off of imgur tool
...
MediaWidget::MediaWidget(const QPixmap& pixmap, QWidget* parent)
	: QWidget(parent),
	m_pixmap(pixmap)
{
...
int MediaWidget::margin() const
{
    return 7;
}

void MediaWidget::wheelEvent(QWheelEvent* e)
{
...
void MediaWidget::mousePressEvent(QMouseEvent* e)
{
...
void MediaWidget::mouseMoveEvent(QMouseEvent* e)
{
...
void MediaWidget::setScaledPixmap(const QSize& size)
{
